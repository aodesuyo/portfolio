...
<!-- フォームパーツ -->
<form class="p-archive__form" action="<?php echo esc_url(home_url('/portfolio/'))?>">

    <label><input type="checkbox" name="portfolio_tag[]" value="コーディング" <?php echo in_array('コーディング',(array)get_query_var('portfolio_tag'))?' checked':''?>><span class="c-category__item">コーディング</span></label>
    <label><input type="checkbox" name="portfolio_tag[]" value="デザイン" <?php echo in_array('デザイン',(array)get_query_var('portfolio_tag'))?' checked':''?>><span class="c-category__item">デザイン</span></label>
    <label><input type="checkbox" name="portfolio_tag[]" value="ライティング" <?php echo in_array('ライティング',(array)get_query_var('portfolio_tag'))?' checked':''?>><span class="c-category__item">ライティング</span></label>
